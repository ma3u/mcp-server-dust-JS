...
var BaseActionSchema = /*#__PURE__*/zod.z.object({
  id: ModelIdSchema,
  type: BaseActionTypeSchema
});
var BrowseActionOutputSchema = /*#__PURE__*/zod.z.object({
  results: /*#__PURE__*/zod.z.array(/*#__PURE__*/zod.z.object({
    requestedUrl: /*#__PURE__*/zod.z.string(),
    browsedUrl: /*#__PURE__*/zod.z.string(),
    content: /*#__PURE__*/zod.z.string(),
    responseCode: /*#__PURE__*/zod.z.string(),
    errorMessage: /*#__PURE__*/zod.z.string()
  }))
});
var BrowseActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  agentMessageId: ModelIdSchema,
  urls: /*#__PURE__*/zod.z.array(/*#__PURE__*/zod.z.string()),
  output: /*#__PURE__*/BrowseActionOutputSchema.nullable(),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("browse_action")
});
var SearchLabelsActionOutputSchema = /*#__PURE__*/zod.z.object({
  tags: /*#__PURE__*/zod.z.array(/*#__PURE__*/zod.z.object({
    tag: /*#__PURE__*/zod.z.string(),
    match_count: /*#__PURE__*/zod.z.number(),
    data_sources: /*#__PURE__*/zod.z.array(/*#__PURE__*/zod.z.string())
  }))
});
var SearchLabelsActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  ...
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("search_labels_action")
});
var ReasoningActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  agentMessageId: ModelIdSchema,
  output: /*#__PURE__*/zod.z.string().nullable(),
  thinking: /*#__PURE__*/zod.z.string().nullable(),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("reasoning_action")
});
var ConversationIncludeFileActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  agentMessageId: ModelIdSchema,
  params: /*#__PURE__*/zod.z.object({
    fileId: /*#__PURE__*/zod.z.string()
  }),
  tokensCount: /*#__PURE__*/zod.z.number().nullable(),
  fileTitle: /*#__PURE__*/zod.z.string().nullable(),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("conversation_include_file_action")
});
var ConversationAttachmentTypeSchema = /*#__PURE__*/zod.z.union([
/*#__PURE__*/
// File case
zod.z.object({
  fileId: /*#__PURE__*/zod.z.string(),
  contentFragmentId: /*#__PURE__*/zod.z.undefined(),
  nodeDataSourceViewId: /*#__PURE__*/zod.z.undefined(),
...
// Node case
zod.z.object({
  fileId: /*#__PURE__*/zod.z.undefined(),
...
var ConversationListFilesActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  files: /*#__PURE__*/zod.z.array(ConversationAttachmentTypeSchema),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  agentMessageId: ModelIdSchema,
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("conversation_list_files_action")
});
var DustAppParametersSchema = /*#__PURE__*/zod.z.record(/*#__PURE__*/zod.z.union([/*#__PURE__*/zod.z.string(), /*#__PURE__*/zod.z.number(), /*#__PURE__*/zod.z["boolean"]()]));
var DustAppRunActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  agentMessageId: ModelIdSchema,
  appWorkspaceId: zod.z.string(),
  appId: zod.z.string(),
  appName: zod.z.string(),
  params: DustAppParametersSchema,
  runningBlock: zod.z.object({
    type: zod.z.string(),
    name: zod.z.string(),
    status: zod.z["enum"](["running", "succeeded", "errored"])
  }).nullable(),
  output: zod.z.unknown().nullable(),
  functionCallId: zod.z.string().nullable(),
  functionCallName: zod.z.string().nullable(),
  step: zod.z.number(),
  type: zod.z.literal("dust_app_run_action")
...
var TimeframeUnitSchema = /*#__PURE__*/zod.z["enum"](TIME_FRAME_UNITS);
var TimeFrameSchema = /*#__PURE__*/zod.z.object({
  duration: /*#__PURE__*/zod.z.number(),
...
var RetrievalActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  ...
  params: /*#__PURE__*/zod.z.object({
    ...
    query: /*#__PURE__*/zod.z.string().nullable(),
    topK: /*#__PURE__*/zod.z.number()
  }),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  documents: /*#__PURE__*/zod.z.array(RetrievalDocumentTypeSchema).nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("retrieval_action")
});
var ProcessSchemaAllowedTypesSchema = /*#__PURE__*/zod.z["enum"](["string", "number", "boolean"]);
var ProcessSchemaPropertySchema = /*#__PURE__*/zod.z.object({
  name: /*#__PURE__*/zod.z.string(),
  type: ProcessSchemaAllowedTypesSchema,
  description: /*#__PURE__*/zod.z.string()
});
var ProcessActionOutputsSchema = /*#__PURE__*/zod.z.object({
  data: /*#__PURE__*/zod.z.array(/*#__PURE__*/zod.z.unknown()),
  min_timestamp: /*#__PURE__*/zod.z.number(),
  total_documents: /*#__PURE__*/zod.z.number(),
  total_chunks: /*#__PURE__*/zod.z.number(),
  total_tokens: /*#__PURE__*/zod.z.number()
});
var ProcessActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  ...
  schema: /*#__PURE__*/zod.z.array(ProcessSchemaPropertySchema),
  outputs: /*#__PURE__*/ProcessActionOutputsSchema.nullable(),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("process_action")
});
var TablesQueryActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  params: DustAppParametersSchema,
  output: /*#__PURE__*/zod.z.record(zod.z.union([zod.z.string(), zod.z.number(), zod.z["boolean"]()])).nullable(),
  resultsFileId: /*#__PURE__*/zod.z.string().nullable(),
  resultsFileSnippet: /*#__PURE__*/zod.z.string().nullable(),
  sectionFileId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallId: /*#__PURE__*/zod.z.string().nullable(),
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  agentMessageId: ModelIdSchema,
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("tables_query_action")
});
...
var WebsearchActionOutputSchema = /*#__PURE__*/zod.z.union([/*#__PURE__*/zod.z.object({
  results: /*#__PURE__*/zod.z.array(WebsearchResultSchema)
}), /*#__PURE__*/zod.z.object({
  results: /*#__PURE__*/zod.z.array(WebsearchResultSchema),
  error: /*#__PURE__*/zod.z.string()
})]);
var WebsearchActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  ...
  functionCallName: /*#__PURE__*/zod.z.string().nullable(),
  step: /*#__PURE__*/zod.z.number(),
  type: /*#__PURE__*/zod.z.literal("websearch_action")
});
var MCPActionTypeSchema = /*#__PURE__*/BaseActionSchema.extend({
  agentMessageId: ModelIdSchema,
  params: /*#__PURE__*/zod.z.unknown(),
  type: /*#__PURE__*/zod.z.literal("tool_action")
});
...
var ContentFragmentSchema = /*#__PURE__*/zod.z.object({
  id: ModelIdSchema,
  sId: /*#__PURE__*/zod.z.string(),
...
var AgentActionTypeSchema = /*#__PURE__*/zod.z.union([RetrievalActionTypeSchema, DustAppRunActionTypeSchema, TablesQueryActionTypeSchema, ProcessActionTypeSchema, WebsearchActionTypeSchema, BrowseActionTypeSchema, ConversationListFilesActionTypeSchema, ConversationIncludeFileActionTypeSchema, ReasoningActionTypeSchema, SearchLabelsActionTypeSchema, MCPActionTypeSchema]);
...
var AgentMessageTypeSchema = /*#__PURE__*/zod.z.object({
  ...
  actions: /*#__PURE__*/zod.z.array(AgentActionTypeSchema),
...
var AgentMesssageFeedbackSchema = /*#__PURE__*/zod.z.object({
  messageId: /*#__PURE__*/zod.z.string(),
...
var GetFeedbacksResponseSchema = /*#__PURE__*/zod.z.object({
  feedbacks: /*#__PURE__*/zod.z.array(AgentMesssageFeedbackSchema)
});
...
var PublicPostConversationsRequestBodySchema = /*#__PURE__*/zod.z.intersection(/*#__PURE__*/zod.z.object({
  ...
  visibility: /*#__PURE__*/zod.z["enum"](["unlisted", "workspace", "deleted", "test"]).optional()["default"]("unlisted"),
...
exports.BrowseActionPublicType = BrowseActionPublicType;
...
exports.isReasoningActionType = isReasoningActionType;
exports.isRetrievalActionType = isRetrievalActionType;
exports.isSearchLabelsActionType = isSearchLabelsActionType;
